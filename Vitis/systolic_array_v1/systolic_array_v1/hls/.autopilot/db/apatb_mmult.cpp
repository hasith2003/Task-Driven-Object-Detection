...
#define AUTOTB_TVIN_out_r "../tv/cdatafile/c.mmult.autotvin_out_r.dat"
#define AUTOTB_TVOUT_out_r "../tv/cdatafile/c.mmult.autotvout_out_r.dat"
#define AUTOTB_TVIN_size "../tv/cdatafile/c.mmult.autotvin_size.dat"
#define AUTOTB_TVOUT_size "../tv/cdatafile/c.mmult.autotvout_size.dat"
...
extern "C"
void mmult_hw_stub_wrapper(void*, void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_mmult_hw(void* __xlx_apatb_param_a, void* __xlx_apatb_param_b, void* __xlx_apatb_param_out_r, hls::sim::Byte<4> __xlx_apatb_param_size)
{
  ...
  static hls::sim::Byte<4> __xlx_offset_byte_param_out_r;
  ...
  port3.param = &__xlx_apatb_param_size;
  ...
  port4.param = { __xlx_apatb_param_a, __xlx_apatb_param_out_r };
  port4.mname = { "a", "out_r" };
  port4.nbytes = { 0, 0 };
  for (size_t i = 0; i < port4.nbytes.size(); ++i) {
    if (port4.nbytes[i] > port4.max_nbytes[i]) {
      port4.max_nbytes[i] = port4.nbytes[i];
    }
  }
  port4.offset.clear();
  for (size_t off = 0, i = 0; i < port4.nbytes.size(); ++i) {
    port4.offset.push_back(off);
    off += hls::sim::divide_ceil(port4.max_nbytes[i], port4.asize);
  }
  __xlx_offset_byte_param_a = port4.offset[0]*4;
  __xlx_offset_byte_param_out_r = port4.offset[1]*4;
  ...
  try {
    ...
    mmult_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b, __xlx_apatb_param_out_r, __xlx_apatb_param_size);
