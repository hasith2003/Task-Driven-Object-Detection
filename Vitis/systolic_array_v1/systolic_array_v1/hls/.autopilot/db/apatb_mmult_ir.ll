; ModuleID = 'D:/DVCon/Vitis/systolic_array_v1/systolic_array_v1/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_mmult_ir(i32* noalias nocapture nonnull readonly "maxi" %a, i32* noalias nocapture nonnull readonly "maxi" %b, i32* noalias nocapture nonnull "maxi" %out, i32 %size) local_unnamed_addr #0 {
entry:
  %a_copy = alloca i32, align 512
  %b_copy = alloca i32, align 512
  %out_copy = alloca i32, align 512
  call fastcc void @copy_in(i32* nonnull %a, i32* nonnull align 512 %a_copy, i32* nonnull %b, i32* nonnull align 512 %b_copy, i32* nonnull %out, i32* nonnull align 512 %out_copy)
  call void @apatb_mmult_hw(i32* %a_copy, i32* %b_copy, i32* %out_copy, i32 %size)
  call void @copy_back(i32* %a, i32* %a_copy, i32* %b, i32* %b_copy, i32* %out, i32* %out_copy)
  ret void
}
...
declare void @apatb_mmult_hw(i32*, i32*, i32*, i32)
...
declare void @mmult_hw_stub(i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull, i32)

define void @mmult_hw_stub_wrapper(i32*, i32*, i32*, i32) #4 {
entry:
  call void @copy_out(i32* null, i32* %0, i32* null, i32* %1, i32* null, i32* %2)
  call void @mmult_hw_stub(i32* %0, i32* %1, i32* %2, i32 %3)
